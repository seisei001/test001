...
| 📚 小説設定ノート | `apps/novel-note/` | 小説の話ごとのあらすじ・固有名詞辞書・伏線(回収/未回収/矛盾)を管理。データはパスワードで守られた暗号化データとしてハブに置き、初回だけパスワードを入れれば自動で読み込む |
...
本文欄の上の「📋 貼り付け」ボタンでクリップボードの内容を本文欄に一発で入れられます(本文は置き換え。iPhoneでは「ペースト」の確認が1回出ます)。「クリア」で本文欄を空にできます。
